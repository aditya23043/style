...
int main(int argc, char *argv[]) {
  ...
  case 0:
    ...
    system("sudo pacman -S --noconfirm --needed ttf-victor-mono-nerd "
           "ttf-jetbrains-mono-nerd ttc-iosevka ttf-ibmplex-mono-nerd "
           "ttf-lekton-nerd ttf-ubuntu-font-family ttf-fira-code "
           "ttf-sarasa-gothic ttf-recursive-nerd ttf-inconsolata-nerd "
           "ttf-sharetech-mono-nerd ttf-monoid-nerd ttf-fira-code "
           "ttf-fantasque-sans-mono ttf-input ttf-martian-mono-nerd "
           "ttf-cascadia-code-nerd ttf-ibm-plex ttf-hack-nerd");
    system("cd /home/adi/AUR && git clone "
           "https://aur.archlinux.org/ttf-pragmasevka-nerd-font && cd "
           "ttf-pragmasevka-nerd-font && makepkg -si && cd");
    system("cd /home/adi/AUR && git clone "
           "https://aur.archlinux.org/ttf-nanumgothic_coding && cd "
           "ttf-nanumgothic_coding && makepkg -si && cd");
    system("cd /home/adi/AUR && git clone "
           "https://aur.archlinux.org/otf-apple-fonts && cd otf-apple-fonts && "
           "makepkg -si && cd");
    break;
