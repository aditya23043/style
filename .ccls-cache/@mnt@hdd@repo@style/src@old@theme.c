...
int main() {
    ...
    // Gruvbox Dark
    case 1:
        strncpy(palette.nvim_colorscheme, "gruvbox-material",
                sizeof("gruvbox-material"));
    ...
    case 3:
        ...
        // Solarized Light
    case 4:
        strncpy(palette.nvim_colorscheme, "NeoSolarized",
                sizeof("NeoSolarized"));
        palette.nvim_background = "light";
        /* palette.fg = "#002b36"; */
        palette.fg = "#576d75";
    ...
    case 6:
        ...
        // Ok colors
    case 7:
        strncpy(palette.nvim_colorscheme, "okcolors-sharp",
                sizeof("okcolors-sharp"));
        palette.nvim_background = "dark";
        palette.bg = "#010102";
        palette.fg = "#fefcf4";
    ...
    case 16:
        strncpy(palette.nvim_colorscheme, "catppuccin_mocha",
                sizeof("catppuccin_mocha"));
        palette.nvim_background = "dark";
        /* palette.fg = "#c6c8d1"; */
        palette.fg = "#cdd6f4";
    ...
    case 17:
        strncpy(palette.nvim_colorscheme, "codedark", sizeof("codedark"));
        palette.nvim_background = "dark";
        palette.fg = "#d4d4d4";
        palette.suggestion = "#3e3e3e";
        palette.bg = "#1e1e1e";
        palette.black = "#3e3e3e";
        palette.red = "#D16969";
        palette.green = "#ebbcba";
        palette.yellow = "#D7BA7D";
        palette.blue = "#569CD6";
        palette.magenta = "#C586C0";
        palette.cyan = "#9CDCFE";
        palette.white = "#d4d4d4";
        palette.dwm_sel_fg = "#000000";
        palette.dwm_norm_fg = "#888888";
        palette.dwm_accent = palette.magenta;
        break;
    ...
    case 18:
        strncpy(palette.nvim_colorscheme, "rosepine", sizeof("rosepine"));
        palette.nvim_background = "dark";
        palette.bg = "#000000";
        palette.fg = "#e0def4";
        palette.suggestion = "#232323";
        palette.black = "#1f1d2e";
        palette.red = "#eb6f92";
        palette.green = "#a9b665";
        palette.yellow = "#f6c177";
        palette.blue = "#31748f";
        palette.magenta = "#c4a7e7";
        palette.cyan = "#9ccfd8";
    ...
    case 19:
        ...
        palette.nvim_background = "dark";
        palette.fg = "#e8e6e3";
        palette.suggestion = "#2a303c";
        palette.bg = "#16191f";
        palette.black = "#000000";
        palette.red = "#ed3c83";
        palette.green = "#4eff85";
        palette.yellow = "#f9ec8c";
        palette.blue = "#0d9fd9";
        palette.magenta = "#fc7cf4";
        palette.cyan = "#6ddbee";
        palette.white = "#ffffff";
        palette.dwm_sel_fg = "#000000";
        palette.dwm_norm_fg = "#888888";
    ...
    while (fgets(init_line, LINE_SIZE, st_conf_file)) {
        ...
        if (regex_value == 0) {
            strncpy(final_line, "static const char *colorname[] = { \"",
                    sizeof("static const char *colorname[] = { \""));
    ...
    while (fgets(init_line, LINE_SIZE, fish_conf_file)) {
        ...
        if (regex_value == 0) {
            strncpy(final_line, "set -U fish_color_autosuggestion \"",
                    sizeof("set -U fish_color_autosuggestion \""));
    ...
    /*     if (regex_value == 0){ */
    /*         strncpy(final_line, "vim.cmd.colorscheme \"",
     * sizeof("vim.cmd.colorscheme \"")); */
    /*         strncat(final_line, palette.nvim_colorscheme,
     * sizeof(palette.nvim_colorscheme)); */
    /*         strncat(final_line, "\"\n", sizeof("\"\n")); */
    /*     } else if (regex_2_value == 0){ */
    /*         strncpy(final_line, "vim.opt.background = \"",
     * sizeof("vim.opt.background = \"")); */
    /*         strncat(final_line, palette.nvim_background,
     * sizeof(palette.nvim_background)); */
    /*         strncat(final_line, "\"\n", sizeof("\"\n")); */
    /*     } else { */
    /*         strncpy(final_line, init_line, sizeof(init_line)); */
    /*     } */
    ...
    /*     if (regex_value == 0){ */
    /*         strncpy(final_line, "\t\t\tvim.api.nvim_set_hl(0,
     * \"iblHighlighted\", { fg = \"", sizeof("\t\t\tvim.api.nvim_set_hl(0,
     * \"iblHighlighted\", { fg = \"")); */
    /*         strncat(final_line, palette.suggestion,
     * sizeof(palette.suggestion)); */
    /*         strncat(final_line, "\" })\n", sizeof("\" })\n")); */
    /*     } else { */
    /*         strncpy(final_line, init_line, sizeof(init_line)); */
    /*     } */
    ...
    while (fgets(init_line, LINE_SIZE, dwm_conf_file)) {
        ...
        if (regex_value == 0) {
            strncpy(final_line, "static const char norm_bg[] = \"",
                    sizeof("static const char norm_bg[] = \""));
            strncat(final_line, palette.bg, sizeof(palette.bg));
            strncat(final_line, "\";\n", sizeof("\";\n"));
        } else if (regex_2_value == 0) {
            strncpy(final_line, "static const char norm_fg[] = \"",
                    sizeof("static const char norm_fg[] = \""));
            strncat(final_line, palette.dwm_norm_fg,
                    sizeof(palette.dwm_norm_fg));
            strncat(final_line, "\";\n", sizeof("\";\n"));
        } else if (regex_3_value == 0) {
            strncpy(final_line, "static const char sel_fg[] = \"",
                    sizeof("static const char sel_fg[] = \""));
            strncat(final_line, palette.dwm_sel_fg, sizeof(palette.dwm_sel_fg));
            strncat(final_line, "\";\n", sizeof("\";\n"));
        } else if (regex_4_value == 0) {
            strncpy(final_line, "static const char accent_col[] = \"",
                    sizeof("static const char accent_col[] = \""));
    ...
    fp = popen("echo -e 'Yes\nNo' | dmenu -p 'Kill DWM?' -fn 'JetBrainsMono "
               "NFM:style=Bold:size=8'",
               "r");
